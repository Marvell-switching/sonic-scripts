...
bug_fixes()
{
    ...
    rm -fr device/marvell/x86_64-marvell_rd98DX7312_32G16HVG6HLG-r0  || true
    rm -fr device/marvell/arm64-marvell_rd98DX7312_32G16HVG6HLG-r0  || true
    tar -C device/marvell/ -xzf mrvl_sonic_hwsku.tgz
    ...
    cp -dr device/marvell/arm64-marvell_rd98DX7312_32G16HVG6HLG-r0 device/marvell/x86_64-marvell_rd98DX7312_32G16HVG6HLG-r0
