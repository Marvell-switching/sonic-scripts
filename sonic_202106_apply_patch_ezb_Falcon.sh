...
SONIC_COMMIT="e2b8e2d1da6977592043ec8b48ca4b0b12768f53"
...
# Path for 202106 patches
WGET_PATH="https://raw.githubusercontent.com/Marvell-switching/sonic-scripts/master/files/202106/"

# Patches
PATCHES="generic_fixes_or_wa.patch
	marvell_arm64_Falcon.patch
	marvell_x86.patch
...
{
    # Download hwsku
    wget -c https://raw.githubusercontent.com/Marvell-switching/sonic-scripts/master/files/mrvl_sonic_hwsku_ezb_falcon.tgz
