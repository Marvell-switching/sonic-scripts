...
SONIC_COMMIT="f355ce18ec9487d494bc8ec2956be01f2aef351d"
...
{
    #PR 5519
    wget -c https://raw.githubusercontent.com/Marvell-switching/sonic-scripts/master/files/202012/shell_buildimage.patch
    patch -p1 < shell_buildimage.patch

    #PR 1454
    pushd src/sonic-swss
    wget -c https://raw.githubusercontent.com/Marvell-switching/sonic-scripts/master/files/202012/shell_swss.patch
    patch -p1 < shell_swss.patch
    popd

    #PR 1146
    pushd src/sonic-utilities
    wget -c https://raw.githubusercontent.com/Marvell-switching/sonic-scripts/master/files/202012/shell_utilities.patch
...
bug_fixes()
{
    ...
    wget -c https://raw.githubusercontent.com/Marvell-switching/sonic-scripts/master/files/202012/linux-ARM64-and-ARMHF-build-changes.patch
    patch -p1 --dry-run < ./linux-ARM64-and-ARMHF-build-changes.patch
    patch -p1 < ./linux-ARM64-and-ARMHF-build-changes.patch
    popd

    wget -c https://raw.githubusercontent.com/Marvell-switching/sonic-scripts/master/files/202012/arm64_sonic_master.patch
    patch -p1 --dry-run < ./arm64_sonic_master.patch
    patch -p1 < ./arm64_sonic_master.patch
